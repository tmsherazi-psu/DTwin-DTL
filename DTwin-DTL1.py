...
from informer import Informer  # Assuming Informer model is available
...
class TimeSeriesDataset(Dataset):
    def __init__(self, data, target_column='oil_temperature', date_column='date', window_size=30):
        ...
        Args:
            ...
            target_column (str): The column for the target variable (oil temperature).
            date_column (str): The column for the date variable to track time.
            window_size (int): The size of the sliding window for time-series prediction.
        """
        self.data = data
...
def main():
    ...
    # Loss Functions
    regression_criterion = nn.MSELoss()  # Using MSE for regression task
